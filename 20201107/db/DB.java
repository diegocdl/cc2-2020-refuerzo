...
**/
	public boolean connect() throws UGDBConnectException{
		try{
			...
			System.out.println("No se encontro libreria asegurese de incluir el sqlitejdbc.jar en su classpath");
...
*	@return	String	contiene el valor de la columna seleccionada
**/
	public String getString(String column) throws UGDBInvalidFieldException{
		String data="";
		try{
			data= RSHash.get("default").getString(column);
		}catch(Exception e){
...
*	@return	String	contiene el valor de la columna seleccionada
**/
	public String getString(String column,String resultSetName) throws UGDBInvalidFieldException{
		String data="";
		try{
			data= RSHash.get(resultSetName).getString(column);
		}catch(Exception e){
